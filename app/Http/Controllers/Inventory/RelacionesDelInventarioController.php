...
class RelacionesDelInventarioController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $conceptoin=ConceptoIn::select('CONCEPTO_IN_ID','NOMBRE')->where('is_active',1)->get();
...
foreach ($relacionc as $relacion )
{
    $relacionclave[] = ['CLAVE_ARTICULO'=> $relacion->CLAVE_ARTICULO,'CLAVE_ARTICULO_ID'=> $relacion->CLAVE_ARTICULO_ID,'relacion_articulos'=>['NOMBRE'=>$relacion->relacion_articulos->NOMBRE, 'UNIDAD_COMPRA'=>$relacion->relacion_articulos->UNIDAD_COMPRA]];
        ...
        return Inertia::render('Inventory/RelacionesDelInventario/Index')->with(compact('conceptoin','sucursal','lineadearticulos','gruposarticulos','clasificadorescat','relacionclave','almacenes'));
