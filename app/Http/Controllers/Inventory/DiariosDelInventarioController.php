...
class DiariosDelInventarioController extends Controller
{
    /**
...
$almacenes=Almacen::select('ALMACEN_ID','NOMBRE')->where('is_active',1)->get();
        ...
        $conceptoin=ConceptoIn::where('is_active',1)->get();
        $relacionclave=[];
...
*/
        ...
        return Inertia::render('Inventory/DiariosDelInventario/Index')->with(compact('sucursal','lineadearticulos','gruposarticulos','clasificadorescat','relacionclave','almacenes','conceptoin'));
    }
