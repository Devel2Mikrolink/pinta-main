...
class WayToPaysController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Accounting/WayToPays/Index')->with(compact('waytopays'));
    }
    ...
    {
        return Inertia::render('Accounting/WayToPays/Create');
    }
    ...
    {
        $savePaymentMethod = new WayToPay();
