...
class PolizasPeriodicasContoller extends Controller
{
    /**
    ...
    {
        $polizasperiodicas=Poliza::all();
     

        return Inertia::render('Contabilidad/PolizasPeriodicas/Index')->with(compact('polizasperiodicas'));
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('Contabilidad/PolizasPeriodicas/Create')->with(compact('tipospolizas','monedas','cuentacos'));
    }
